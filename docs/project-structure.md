...
| a screen of your interface (a `ScreenGui`) | `src/client/ui/screens/` (`rowork make:screen`) |
| an element of your interface (button, panel...) | `src/client/ui/` (`rowork make:ui`), one component per file |
